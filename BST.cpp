...
void printNode(BTNode *node, int level, int curLevel = 0)
{
    ...
    if (level == curLevel)
    {
        ...
        printNode(node->left, level, curLevel + 1);
        printNode(node->right, level, curLevel + 1);
    }
}

void ascendingNode(BTNode *node , int source)
{
    ...
    {
        node->item.print(cout);
        ascendingNode(node->left, 1);
        ascendingNode(node->right, 1);
    }
    else if (source == 2)
    {
        node->item.print(inFile);
        ascendingNode(node->left, 2);
        ascendingNode(node->right , 2);
        inFile.close();
    }
}

void descendingNode(BTNode *node , int source)
{
    ...
    {
        node->item.print(cout);
        descendingNode(node->right, 2);
        descendingNode(node->left, 2);
    }
    else if (source == 2)
    {
        node->item.print(inFile);
...
bool BST::deepestNode(BST *cur)
{
    if (cur == nullptr) return false;

    int height = log2(cur->size()) + 1;
...
{
    ifstream inFile("student-info.txt");
    if (root == NULL)return false;
    if (order == 1)
    {
        if (source == 1)
        {
            ascendingNode(root , 1);
        }
        else if (source == 2)
        {
            ascendingNode(root , 2);
        }
        else
        {
            return false;
    ...
    else if (order == 2)
    {
        if (source == 1)
        {
            descendingNode(root, 1);
        }
        else if (source == 2)
        {
            descendingNode(root, 2);
        }
        else
        {
            return false;
